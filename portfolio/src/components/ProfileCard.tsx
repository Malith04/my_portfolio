...
const DEFAULT_INNER_GRADIENT =
  'linear-gradient(145deg, rgba(0, 245, 212, 0.07) 0%, rgba(121, 40, 202, 0.09) 50%, rgba(197, 168, 128, 0.05) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  useEffect(() => {
    ...
    const pointerMoveHandler = handlePointerMove as unknown as (e: Event) => void;
    const pointerEnterHandler = handlePointerEnter as unknown as (e: Event) => void;
    const pointerLeaveHandler = handlePointerLeave as unknown as (e: Event) => void;
    const deviceOrientationHandler = handleDeviceOrientation as unknown as (e: Event) => void;
          ...
          <div className="pc-inside">
            ...
            <div className="pc-content">
              <div className="pc-details">
                <div className="pc-react-badge">
                  <svg viewBox="-11.5 -10.23174 23 20.46348" className="pc-react-icon" aria-hidden="true">
                    <circle cx="0" cy="0" r="2.05" fill="#00F5D4" />
                    <g stroke="#00F5D4" strokeWidth="1" fill="none">
