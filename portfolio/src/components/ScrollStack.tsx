...
export const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const getElementOffset = useCallback(
    (element: HTMLElement) => {
      if (useWindowScroll) {
        // Measure un-transformed wrapper when available to avoid CSS transform feedback loops
        const wrapper = element.closest('.scroll-stack-card-wrapper') as HTMLElement | null;
